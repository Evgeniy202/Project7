                    ...
                    <div class="row">
                        <form action="{{ route('banner.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <div class="form-group mt-3">
                                    <input type="number" name="priority" id="priority" placeholder="Пріорітет..."
                                           class="form-control">
                                </div>
                                <div class="form-group mt-3">
            ...
            <tr>
                ...
                <td>
                    <button class="btn btn-warning col-5" data-bs-toggle="modal"
                            data-bs-target="#changeModal-{{ $banner->id }}">Деталі або редагувати
                    </button>
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <form action="{{ route('banner.update', $banner) }}" method="POST"
                                            ...
                                            <div class="form-group mt-3">
                                                <div class="form-group mt-3">
                                                    <input type="text" name="title" id="title" placeholder="Ім'я..."
                                                ...
                                                <div class="form-group mt-3">
                                                    @if($banner->active == 1)
                                                        <label>Активний <input type="checkbox" name="active"
                                                                                id="active"
                                                                                value="1"
                                                                                checked></label>
                                                    @else
                                                ...
                                                <div class="form-group mt-3">
                                                    <textarea class="form-control" name="description" id="description"
                                                              rows="10"
                                                              placeholder="Опис...">{{ $banner->description }}
                                                    </textarea>
                                                </div>
                                            </div>
                                            <hr>
