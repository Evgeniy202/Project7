                    ...
                    <div class="collapse" id="dashboard-collapse" style="">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                            ...
                            <li><a href="{{ route('orders-status', 'Executed') }}"
                                   class="link-dark rounded">Виконані</a></li>
                            <li><a href="{{ route('orders-status', 'Cancelled') }}"
                                   class="link-dark rounded">Скасовані</a></li>
                            <hr>
            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item dropdown">
                    <a href="#" id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button"
                       data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Інструменти</a>
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="{{ route('forgetCategoriesSession') }}">Забути Категорії
                            Сесії</a>
                    </div>
                </li>
            </ul>
